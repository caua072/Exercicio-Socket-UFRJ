...
# A logica dessa função é converter qualquer que for o valor de origem para a base decimal e depois converter da base decimal para a base solicitada.
...
def convert_base(value, from_base, to_base):
    ...
    if to_base == 'bin':
        return bin(decimal_value)[2:]  # remove o prefixo '0b'
    elif to_base == 'hex':
        return hex(decimal_value)[2:]  # remove o prefixo '0x'
    elif to_base == 'dec':
